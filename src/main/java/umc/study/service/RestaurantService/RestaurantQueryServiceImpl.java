...
public class RestaurantQueryServiceImpl implements RestaurantQueryService {
    ...
    @Override
    public List<Restaurant> findRestaurantByNameANDTotalRating(String name, Float score){
        List<Restaurant> filteredRestaurants = restaurantRepository.dynamicQueryWithBooleanBuilder(name, score);
        filteredRestaurants.forEach(restaurant -> System.out.println("Restaurant: " + score));
